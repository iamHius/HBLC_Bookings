...
namespace HBLC_Bookings.Controllers
{
    public class RoomServicesController : Controller
    {
        ...
        {
              return _context.RoomServices != null ? 
                          View(await _context.RoomServices.ToListAsync()) :
                          Problem("Entity set 'ApplicationDbContext.RoomServices'  is null.");
        }
        ...
        {
          return (_context.RoomServices?.Any(e => e.RoomServiceId == id)).GetValueOrDefault();
        }
    }
}
